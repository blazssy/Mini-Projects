...
player_bullet_fx = pygame.mixer.Sound('Sounds/shoot.wav')
click_fx = pygame.mixer.Sound('Sounds/click.mp3')
collision_fx = pygame.mixer.Sound('Sounds/we_explode.mp3')
blast_fx = pygame.mixer.Sound('Sounds/enemy_destroy.mp3')
...
while running:
	...
	if home_page:
		win.fill(BLACK)
		win.blit(logo_img, (200, 100))
		win.blit(fighter_img, (WIDTH//2 - 100, HEIGHT//2))
		tap_to_play_msg.update()
		font = pygame.font.Font(None,36)

		image = pygame.image.load('Assets/Diseases/a.png')
		win.blit(image, (50, 40))
		pathogen_text = font.render("Escherichia ! ", True, WHITE)
		win.blit(pathogen_text, (30, 140))

		image = pygame.image.load('Assets/Diseases/b.png')
		win.blit(image, (50, 200))
		pathogen_text = font.render("Lactobacillus ! ", True, WHITE)
		win.blit(pathogen_text, (30, 300))

		image = pygame.image.load('Assets/Diseases/c.png')
		win.blit(image, (50, 375))
		pathogen_text = font.render("Clostridium ! ", True, WHITE)
		win.blit(pathogen_text, (30,460))

		image = pygame.image.load('Assets/Diseases/e.png')
		win.blit(image, (WIDTH-150, 40))
		pathogen_text = font.render("Covid-19 ! ", True, WHITE)
		win.blit(pathogen_text, (WIDTH-150,160))

		image = pygame.image.load('Assets/Diseases/d.png')
		win.blit(image, (WIDTH-150, 200))
		pathogen_text = font.render("Common Cold ! ", True, WHITE)
		win.blit(pathogen_text, (WIDTH-190,300))

		image = pygame.image.load('Assets/Diseases/f.png')
		win.blit(image, (WIDTH-150, 375))
		pathogen_text = font.render("WBC - Collect", True, WHITE)
		win.blit(pathogen_text, (WIDTH-180,480))
